		...
		AdapterHolder holder1 = null;
		 int type = getItemViewType(position);  
			if(null==convertView){
				switch(type){
				case HEAD :
					convertView = inflater.inflate(R.layout.listview_attendance_head,
							parent, false);
				...
				case CONTENT :
					...
					convertView = inflater.inflate(R.layout.listview_attendance,
							parent, false);
				...
				case CONTENTDARK:
					...
					convertView = inflater.inflate(R.layout.listview_attendance_dark,
							parent, false);
